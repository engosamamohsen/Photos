...
import app.paymob.task.data.local.preferences.AppPreferences
import com.google.gson.Gson
import com.google.gson.GsonBuilder
import com.readystatesoftware.chuck.BuildConfig
import com.readystatesoftware.chuck.ChuckInterceptor
import com.structure.base_mvvm.BuildConfig.APIKEY
import com.structure.base_mvvm.BuildConfig.API_BASE_URL
...
//        .addInterceptor(ChuckInterceptor(context)) //crash in android 33
        .build()
    } else {
      OkHttpClient.Builder()
        .readTimeout(REQUEST_TIME_OUT, TimeUnit.SECONDS)
